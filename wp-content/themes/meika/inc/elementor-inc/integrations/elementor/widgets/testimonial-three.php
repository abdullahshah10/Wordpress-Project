...
class Elementor_testimonial_three extends Widget_Base {

	public function get_name() {
		return 'Elementor-testimonial-three';
	}

	public function get_title() {
		return esc_html__( 'Zc >  Testimonial Three' ,'meika' );
	}
	...
	protected function render( $instance = [] ) {
		...
		meika_el()->get_section('testimonial-three', [
...
Plugin::instance()->widgets_manager->register_widget_type( new Elementor_testimonial_three() );