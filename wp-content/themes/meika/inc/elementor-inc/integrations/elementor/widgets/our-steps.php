...
class Elementor_steps extends Widget_Base {

	public function get_name() {
		return 'Elementor-steps';
	}

	public function get_title() {
		return esc_html__( 'Zc > Our Steps' ,'meika' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'services_section',
			['label' => esc_html__( 'Our Steps','meika'),]
		);
	...
	protected function render( $instance = [] ) {
		...
		meika_el()->get_section('our-steps', [
...
Plugin::instance()->widgets_manager->register_widget_type( new Elementor_steps() );