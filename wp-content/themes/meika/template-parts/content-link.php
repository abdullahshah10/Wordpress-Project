                    ...
                    <div class="entry-excerpt">  
						<div class="row">					
                          <div class="link">                           
                            ...
                            <?php if (is_single() ) {
                            the_content();
                            $link = rwmb_meta( 'meikazc_post_link' ); echo esc_url ($link);

                        } elseif ( is_search() OR is_archive() ) {?>
                            <p>
                                <a href="<?php $link = rwmb_meta( 'meikazc_post_link' ); echo esc_url ($link); ?>">
                                        <?php $link = rwmb_meta( 'meikazc_post_link' ); echo esc_url ($link); ?>
                                    </a>
