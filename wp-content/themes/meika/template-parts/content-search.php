                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="meta-info">
                                <ul>
                                    <li>
                                            <i class="far fa-user"></i><?php esc_html_e( 'By', 'meika' ); ?> <?php the_author(); ?></li>
                                    <li><i class="far fa-comments"></i> <?php echo get_comments_number();?> <?php esc_html_e( 'Comment', 'meika' ); ?></li>
